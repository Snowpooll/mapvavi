...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { address: @point.address, latitude: @point.latitude, longitude: @point.longitude, title: @point.title }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { address: @point.address, latitude: @point.latitude, longitude: @point.longitude, title: @point.title }
    assert_redirected_to point_path(assigns(:point))
  end
